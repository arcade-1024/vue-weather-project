	...
	<header class="sticky top-0 bg-weather-primary shadow-lg">
		...
		>
			...
			<div class="flex gap-3 flex-1 justify-end">
				<i
					class="fa-solid fa-circle-question text-xl hover:text-weather-secondary duration-150 cursor-pointer"
					@click="toggleModal"
				></i>
				<i
					class="fa-solid fa-plus text-xl cursor-pointer"
					@click="addCity"
...
const addCity = () => {
	...
	if (getCityData) {
		savedCities.value = JSON.parse(getCityData);
	}
	const locationObj = {
		id: uid(),
